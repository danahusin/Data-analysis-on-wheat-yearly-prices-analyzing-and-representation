...
plt.plot(project_file['year'],project_file['year_high'],label="year_open price per year ",color='b',marker='o',markersize=3)
plt.plot(project_file['year'],project_file['year_low'],label="year_close price per year ",color='r',marker='o',markersize=3)
plt.legend()
